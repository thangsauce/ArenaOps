    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-arena-bg font-sans text-arena-text overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative bg-[linear-gradient(180deg,rgba(255,255,255,0.55),transparent)] dark:bg-none">
        ...
        <motion.div
          ...
          className="w-full max-w-md my-auto pb-10 rounded-[28px] border border-black/6 dark:border-white/8 bg-white/88 dark:bg-arena-surface/70 backdrop-blur-xl shadow-[0_28px_80px_rgba(17,24,39,0.08)] dark:shadow-[0_28px_80px_rgba(0,0,0,0.38)] p-8 sm:p-10"
        >
          {/* Mobile Logo */}
          <Link
            to="/"
