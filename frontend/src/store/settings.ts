...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  schedulePrefs: { weekStart: "monday", defaultView: "grid" },
  bracketPrefs: { defaultView: "tree" },
...
export interface DelayedMatchTimer {
  startAt: number;
...
export interface AppState {
  ...
  unreadCount: number;
  delayedMatchTimers: Record<string, DelayedMatchTimer>;
  ...
  setDelayedMatchTimer: (
    matchId: string,
    timer: DelayedMatchTimer,
  ) => void;
  clearDelayedMatchTimer: (matchId: string) => void;
