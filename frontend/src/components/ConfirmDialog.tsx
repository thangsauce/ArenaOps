      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative bg-arena-surface rounded-2xl border border-arena-border shadow-lg p-6 max-w-[400px] w-full mx-4"
            initial={{ scale: 0.92, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0.92, opacity: 0 }}
            transition={{ duration: 0.18, ease: 'easeOut' }}
          >
            <h2 id="confirm-dialog-title" className="font-bold text-arena-text text-base mb-1">
              {title}
            </h2>
