...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 ${positionClass} z-50 flex items-center justify-center w-10 h-10 rounded-full shadow-xl border transition-all duration-300 active:scale-95 hover:scale-105`}
      style={{
