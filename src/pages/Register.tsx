    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-arena-bg font-sans text-gray-100 overflow-hidden">
      ...
      <div className="hidden md:flex md:w-5/12 lg:w-1/2 relative p-12 flex-col justify-center overflow-hidden border-r border-arena-border bg-[#0d0d14]">
        ...
        <div className="relative z-10 max-w-md mx-auto">
          ...
          >
            Built for clubs,<br />built for game day.
          </motion.h2>
          ...
          >
            Join hundreds of university esports clubs running smoother events with ArenaOPS.
          </motion.p>
          ...
          >
            {[
              'Free for university clubs — no credit card needed',
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        >
          {/* Mobile Logo */}
          <Link to="/" className="flex md:hidden items-center gap-2 mb-10 justify-center">
            <div className="p-2 bg-arena-accent/10 rounded-lg text-arena-accent">
              <Zap size={22} className="fill-current" />
            </div>
          ...
          <div className="mb-8 text-center md:text-left">
            <h1 className="font-display text-4xl font-bold uppercase tracking-tight mb-2">Create account</h1>
            <p className="text-gray-400">Start managing tournaments for free</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2 flex flex-col items-start w-full">
              <label className="text-sm font-semibold text-gray-300 ml-1" htmlFor="email">University email</label>
              <div className="relative flex items-center w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full">
              <div className="space-y-2 flex flex-col items-start w-full">
                ...
                <div className="relative flex items-center w-full">
                  <Lock size={18} className="absolute left-4 z-10 text-gray-500 pointer-events-none" />
                  <input
                    id="password"
              ...
              <div className="space-y-2 flex flex-col items-start w-full">
                <label className="text-sm font-semibold text-gray-300 ml-1" htmlFor="confirmPass">Confirm</label>
                <div className="relative flex items-center w-full">
                  <Lock size={18} className="absolute left-4 text-gray-500 pointer-events-none z-10" />
                  <input
                    id="confirmPass"
                    type={showPass ? 'text' : 'password'}
            ...
            {error && (
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-sm font-medium text-red-400 bg-red-400/10 border border-red-400/20 py-2 px-3 rounded-lg text-center mt-2">
                {error}
              </motion.p>
            )}
            ...
            <p className="text-xs text-gray-500 text-center leading-relaxed mt-4">
              By creating an account you agree to our <br/><span className="text-gray-400 hover:text-white cursor-pointer transition-colors">Terms of Service</span> and <span className="text-gray-400 hover:text-white cursor-pointer transition-colors">Privacy Policy</span>.
            </p>
          </form>

          <p className="mt-8 text-center text-gray-400 font-medium text-sm">
            Already have an account?{' '}
            <Link to="/login" className="text-arena-accent hover:text-white transition-colors font-bold ml-1">Sign in</Link>
          </p>
        </motion.div>
      </div>
    </div>
