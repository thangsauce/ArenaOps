...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  tournamentDefaults: { format: 'single-elimination', maxParticipants: '8', organizerName: 'Casey Segura' },
  schedulePrefs: { weekStart: 'sunday', defaultView: 'grid' },
  participantPrefs: { sortBy: 'seed', hideDeclined: false },
  profile: { name: 'Casey Segura', email: 'casey@ucf.edu', university: 'University of Central Florida' },
};
